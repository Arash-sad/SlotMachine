...
//  SlotMachine
//
//  Created by Arash Sadeghieh E on 18/09/2014.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupThirdContainer(self.thisrdContainer)
    ...
    func betOneButoonPressed(button:UIButton){
        if credits <= 0 {
    ...
    func betMaxButoonPressed(button:UIButton){
        if credits <= 5 {
    ...
    func spinButoonPressed(button:UIButton){
    ...
    func setupContainerViews() {
        ...
        self.firstContainer.backgroundColor = UIColor.cyanColor()
        ...
        self.thisrdContainer = UIView(frame: CGRectMake(self.view.bounds.origin.x + kMarginForView, firstContainer.frame.height + secondContainer.frame.height, self.view.bounds.width - (kMarginForView * 2), self.view.bounds.height * kSixth))
        self.thisrdContainer.backgroundColor = UIColor.lightGrayColor()
        self.view.addSubview(self.thisrdContainer)
        
        self.fourthContainer = UIView(frame: CGRectMake(self.view.bounds.origin.x + kMarginForView, firstContainer.frame.height + secondContainer.frame.height + thisrdContainer.frame.height, self.view.bounds.width - (kMarginForView * 2), self.view.bounds.height * kSixth))
    ...
    func setupThirdContainer(containerView: UIView){
        ...
        self.creditsLabel.textColor = UIColor.cyanColor()
        ...
        self.betLabel.textColor = UIColor.cyanColor()
        ...
        self.winnerPaidLabel.textColor = UIColor.cyanColor()
        ...
        self.creditsTitleLabel.font = UIFont(name: "AmericanTypewrite", size: 14)
        ...
        self.betTitleLabel.font = UIFont(name: "AmericanTypewrite", size: 14)
        ...
        self.winnerPaidTitleLabel.font = UIFont(name: "AmericanTypewrite", size: 14)
    ...
    func setupFourthContainer(containerView: UIView){
        ...
        self.resetButton.backgroundColor = UIColor.cyanColor()
        ...
        self.betOneButton.backgroundColor = UIColor.cyanColor()
        self.betOneButton.sizeToFit()
        self.betOneButton.center = CGPointMake(containerView.frame.width * kEighth * 3, containerView.frame.height * kHalf)
        self.betOneButton.addTarget(self, action: "betOneButoonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.betMaxButton.backgroundColor = UIColor.cyanColor()
        self.betMaxButton.sizeToFit()
        self.betMaxButton.center = CGPointMake(containerView.frame.width * kEighth * 5, containerView.frame.height * kHalf)
        self.betMaxButton.addTarget(self, action: "betMaxButoonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.spinButton.backgroundColor = UIColor.cyanColor()
        self.spinButton.sizeToFit()
        self.spinButton.center = CGPointMake(containerView.frame.width * kEighth * 7, containerView.frame.height * kHalf)
        self.spinButton.addTarget(self, action: "spinButoonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
